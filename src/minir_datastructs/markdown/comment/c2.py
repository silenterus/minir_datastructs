...
from typing import Union, Tuple, Optional, Dict, cast, List
...
class StandardCommentSymbolOneLine(Enum):
    ...
    DOUBLE_ASTERISK_JAVADOC_START_LINE = ("double_asterisk_javadoc_start_line", 15, "/**")
    AT_SIGN_BATCH = ("at_sign_batch", 16, "@")
    DOUBLE_SEMICOLON_WAT = ("double_semicolon_wat", 17, ";;")
    BATCH_DOUBLE_COLON_LINE = ("batch_double_colon_line", 18, "::")
    ...
    M4_DNL_LINE = ("m4_dnl_line", 22, "dnl")
    VIML_DOUBLE_QUOTE_LINE = ("viml_double_quote_line", 23, "\"")
    FORTH_BACKSLASH_EOL_LINE = ("forth_backslash_eol_line", 24, "\\ ")
    TLAPLUS_LINE = ("tlaplus_line", 25, "\\*")
    MERMAID_DOUBLE_PERCENT_LINE = ("mermaid_double_percent_line", 26, "%%")
    IDRIS_DOC_LINE = ("idris_doc_line", 27, "|||")
    RST_EXPLICIT_COMMENT_LINE = ("rst_explicit_comment_line", 28, ".. ")
    SLIM_SLASH_LINE = ("slim_slash_line", 29, "/")
    HAML_HYPHEN_HASH_LINE = ("haml_hyphen_hash_line", 30, "-#")
    VELOCITY_DOUBLE_HASH_LINE = ("velocity_double_hash_line", 31, "##")
    PUG_SLASH_SLASH_HYPHEN_LINE = ("pug_slash_slash_hyphen_line", 32, "//-")
    BLITZMAX_REM_LOWERCASE = ("blitzmax_rem_lowercase", 33, "rem")
    BLITZMAX_SINGLE_QUOTE = ("blitzmax_single_quote", 34, "'")
    ABAP_ASTERISK_LINE_START = ("abap_asterisk_line_start", 35, "*")
    ABAP_DOUBLE_QUOTE_NON_FIRST_COL = ("abap_double_quote_non_first_col", 36, "\"")
    SLASH_SLASH_SLASH_DOC = TRIPLE_SLASH_DOC
    NOTE_FOXPRO_LINE = ("note_foxpro_line", 37, "NOTE")
    DOUBLE_AMPERSAND_XBASE_LINE = ("double_ampersand_xbase_line", 38, "&&")
    NB_DOT_JLANG_LINE = ("nb_dot_jlang_line", 39, "NB.")
    JCL_DOUBLE_SLASH_STAR_LINE = ("jcl_double_slash_star_line", 40, "//*")
    DOT_BACKSLASH_DOUBLE_QUOTE_ROFF_LINE = ("dot_backslash_double_quote_roff_line", 41, ".\\\"")
    FAUST_TRIPLE_HYPHEN_DOC_LINE = ("faust_triple_hyphen_doc_line", 42, "---")
    CLARION_PIPE_LINE = ("clarion_pipe_line", 43, "|")
    BLITZMAX_REM_UPPERCASE = ("blitzmax_rem_uppercase", 44, "Rem")
    HASH_SPACE_ORGMODE = ("hash_space_orgmode", 45, "# ")
    BACKSLASH_FORTH_SHEN = ("backslash_forth_shen", 46, "\\")
    EXCLAMATION_SMALLTALK_LINE = ("exclamation_smalltalk_line", 47, "!")
...
class StandardCommentSymbolMultiLine(Enum):
    ...
    PASCAL_OCAML_ML_CURLY_BRACE = ("pascal_ocaml_ml_curly_brace", 6, "{", "}") # Merged PASCAL_OCAML_ML_CURLY_ASTERISK and PASCAL_CURLY_BRACE
    ...
    SMALLTALK_DOUBLE_QUOTE_BLOCK = ("smalltalk_double_quote_block", 12, '"', '"') # Merged SMALLTALK_DOUBLE_QUOTE
    ...
    ASCIIDOC_BLOCK = ("asciidoc_block", 21, "////", "////") # Merged ASCIIDOC_QUAD_SLASH_BLOCK
    WAT_PAREN_SEMICOLON_BLOCK = ("wat_paren_semicolon_block", 22, "(;", ";)")
    COFFEESCRIPT_BLOCK = ("coffeescript_block", 23, "###", "###") # Merged COFFEESCRIPT_TRIPLE_HASH_BLOCK
    CFML_BLOCK = ("cfml_block", 24, "<!---", "--->") # Merged CFML_HYPHEN_BRACKET
    FORTH_PAREN_SPACED_BLOCK = ("forth_paren_spaced_block", 25, "( ", " )") # Merged FORTH_PAREN_BLOCK from B1 and FORTH_PAREN_SPACE_BLOCK_ENUM from B2
    XQUERY_COMMENT_BLOCK = ("xquery_comment_block", 26, "(:", ":)") # Merged XQUERY_PAREN_COLON_BLOCK
    ...
    CMAKE_BRACKET_BLOCK = ("cmake_bracket_block", 30, "#[[", "]]") # Merged CMAKE_HASH_DOUBLE_BRACKET
    JSP_COMMENT_BLOCK = ("jsp_comment_block", 31, "<%--", "--%>") # Merged ASP_JSP_PERCENT_HYPHEN_BLOCK
    RAZOR_COMMENT_BLOCK = ("razor_comment_block", 32, "@*", "*@") # Merged RAZOR_AT_ASTERISK_BLOCK
    SMARTY_COMMENT_BLOCK = ("smarty_comment_block", 33, "{*", "*}") # Merged SMARTY_ASTERISK_BRACE
    TWIG_COMMENT_BLOCK = ("twig_comment_block", 34, "{#", "#}") # Merged TEMPLATE_HASH_BRACE
    FREEMARKER_COMMENT_BLOCK = ("freemarker_comment_block", 35, "<#--", "-->") # Merged FREEMARKER_LANGLE_HASH_HYPHEN_BLOCK
    VELOCITY_HASH_ASTERISK_BLOCK = ("velocity_hash_asterisk_block", 36, "#*", "*#")
    MAKO_DOC_BLOCK = ("mako_doc_block", 37, "<%doc>", "</%doc>") # Merged MAKO_DOC_TAG
    ...
    LIQUID_COMMENT_BLOCK = ("liquid_comment_block", 41, "{% comment %}", "{% endcomment %}") # Merged LIQUID_COMMENT_TAG_BLOCK
    HANDLEBARS_EXCLAMATION_DASH_BLOCK = ("handlebars_exclamation_dash_block", 42, "{{!--", "--}}") # Merged TEMPLATE_EXCLAMATION_HYPHEN_BRACE
    HANDLEBARS_EXCLAMATION_BLOCK = ("handlebars_exclamation_block", 43, "{{!", "}}") # Merged TEMPLATE_EXCLAMATION_BRACE
    RPM_SPEC_CHANGELOG_BLOCK = ("rpm_spec_changelog_block", 44, "%changelog", "") # Merged RPM_SPEC_CHANGELOG_BLOCK_ENUM
    JSX_TSX_CURLY_SLASH_ASTERISK_BLOCK = ("jsx_tsx_curly_slash_asterisk_block", 45, "{/*", "*/}")
    AUTOIT_HASH_CS_CE_BLOCK = ("autoit_hash_cs_ce_block", 46, "#cs", "#ce")
    AUTOIT_HASH_COMMENTS_BLOCK = ("autoit_hash_comments_block", 47, "#comments-start", "#comments-end")
    GAMS_DOLLAR_ONOFF_TEXT_BLOCK = ("gams_dollar_onoff_text_block", 48, "$ontext", "$offtext")
    GCODE_PAREN_BLOCK = ("gcode_paren_block", 49, "(", ")") # Merged from B1/B2
    ...
    OCTAVE_HASH_BRACE_BLOCK = ("octave_hash_brace_block", 53, "#{", "}")
    PAPYRUS_BRACE_BLOCK = ("papyrus_brace_block", 54, "{", "}")
    SIMULA_COMMENT_KEYWORD_BLOCK = ("simula_comment_keyword_block", 55, "COMMENT", ";")
    WENYAN_SHU_YUE_BLOCK = ("wenyan_shu_yue_block", 56, "疏曰。「", "」")
    RAKU_HASH_PAREN_BLOCK = ("raku_hash_paren_block", 57, "#(", ")")
    RAKU_EMBEDDED_DOC_BLOCK = ("raku_embedded_doc_block", 58, "=begin comment", "=end comment")
    CEYLON_TRIPLE_QUOTE_DOC_BLOCK = ("ceylon_triple_quote_doc_block", 59, "\"\"\"", "\"\"\"") # Merged CEYLON_TRIPLE_QUOTE_DOC
    NIM_HASH_DOUBLE_BRACKET_DOC_BLOCK = ("nim_hash_double_bracket_doc_block", 60, "#[[", "]]#") # Merged NIM_HASH_DOUBLE_BRACKET_DOC
    EJS_PERCENT_HASH_BLOCK = ("ejs_percent_hash_block", 61, "<%#", "%>") # From B2 EJS_PERCENT_HASH
    FORTH_PAREN_UNSPACED_BLOCK = ("forth_paren_unspaced_block", 62, "(", ")") # From B2 FORTH_PAREN_BLOCK (distinct from spaced)
    ...
    def __post_init__(self):
        ...
        if self.type == CommentDefinitionType.MULTI_LINE:
            if self.end_delimiter is None or not self.end_delimiter:
                if self.key != "rpm_spec_changelog_block_def":
                    raise ValueError(
                        f"Multi-line comment definition '{self.key}' must have a non-empty end_delimiter or be an allowed special case (e.g. rpm_spec_changelog_block_def).")
...
def _initialize_comment_configurations() -> None:
    ...
    definitions_data: Dict[str, CommentSyntaxDefinition] = {
        ...
        "c_preprocessor_block_def": CommentSyntaxDefinition(key="c_preprocessor_block_def", type=CommentDefinitionType.MULTI_LINE, start_delimiter="#if 0", end_delimiter="#endif", requires_line_start=True),
        ...
        "rem_blitz_max_lowercase_def": CommentSyntaxDefinition(key="rem_blitz_max_lowercase_def", type=CommentDefinitionType.SINGLE_LINE, start_delimiter="rem", requires_line_start=True),
        "rem_blitz_max_uppercase_def": CommentSyntaxDefinition(key="rem_blitz_max_uppercase_def", type=CommentDefinitionType.SINGLE_LINE, start_delimiter="Rem", requires_line_start=True),
        ...
        "fortran_fixed_c_spaced_col1_line_def": CommentSyntaxDefinition(key="fortran_fixed_c_spaced_col1_line_def", type=CommentDefinitionType.SINGLE_LINE, start_delimiter="C ", column_specific_start=1),
        ...
        "fortran_fixed_star_spaced_col1_line_def": CommentSyntaxDefinition(key="fortran_fixed_star_spaced_col1_line_def", type=CommentDefinitionType.SINGLE_LINE, start_delimiter="* ", column_specific_start=1),
        ...
        "forth_paren_unspaced_block_def": CommentSyntaxDefinition(key="forth_paren_unspaced_block_def", type=CommentDefinitionType.MULTI_LINE, start_delimiter="(", end_delimiter=")"),
        ...
        "sas_asterisk_semicolon_block_def": CommentSyntaxDefinition(key="sas_asterisk_semicolon_block_def", type=CommentDefinitionType.MULTI_LINE, start_delimiter="*", end_delimiter=";", requires_line_start=True),
        ...
        "rpm_spec_changelog_block_def": CommentSyntaxDefinition(key="rpm_spec_changelog_block_def", type=CommentDefinitionType.MULTI_LINE, start_delimiter="%changelog", end_delimiter="", requires_line_start=True),
        ...
        "ejs_percent_hash_block_def": CommentSyntaxDefinition(key="ejs_percent_hash_block_def", type=CommentDefinitionType.MULTI_LINE, start_delimiter="<%#", end_delimiter="%>"),
        "hash_space_orgmode_line_def": CommentSyntaxDefinition(key="hash_space_orgmode_line_def", type=CommentDefinitionType.SINGLE_LINE, start_delimiter="# "),
        "backslash_forth_shen_line_def": CommentSyntaxDefinition(key="backslash_forth_shen_line_def", type=CommentDefinitionType.SINGLE_LINE, start_delimiter="\\"),
        "exclamation_smalltalk_line_def": CommentSyntaxDefinition(key="exclamation_smalltalk_line_def", type=CommentDefinitionType.SINGLE_LINE, start_delimiter="!"),
    }
...
def _populate_language_profiles_registry() -> None:
    ...
    profiles = [
        ...
        create_profile("csharp", c_style_doc_defs + ("c_preprocessor_block_def",)),
        create_profile("c", c_style_base_defs + ("c_preprocessor_block_def",)),
        create_profile("cpp", c_style_doc_defs + ("c_preprocessor_block_def",)),
        create_profile("java", ("c_line_comment_def", "c_block_comment_def", "doc_block_slash_double_asterisk_def")),
        create_profile("javascript", ("c_line_comment_def", "c_block_comment_def", "doc_block_slash_double_asterisk_def")),
        create_profile("typescript", c_style_doc_defs),
        create_profile("jsx", ("c_line_comment_def", "c_block_comment_def", "doc_block_slash_double_asterisk_def", "jsx_tsx_curly_slash_asterisk_def")),
        ...
        create_profile("kotlin", ("c_line_comment_def", "c_block_comment_def", "doc_block_slash_double_asterisk_def")),
        create_profile("scala", ("c_line_comment_def", "c_block_comment_def", "doc_block_slash_double_asterisk_def")),
        ...
        create_profile("sass", ("c_line_comment_def", "c_block_comment_nestable_def"), handle_strings=True), # SCSS syntax
        ...
        create_profile("json", ("c_line_comment_def", "c_block_comment_def"), handle_strings=True), # For JSONC/JSON5
        ...
        create_profile("fortran", ("fortran_exclamation_line_def", "fortran_fixed_c_col1_line_def", "fortran_fixed_c_spaced_col1_line_def", "fortran_fixed_star_col1_line_def", "fortran_fixed_alt_c_col1_line_def", "fortran_fixed_star_spaced_col1_line_def")),
        ...
        create_profile("objectivec", c_style_doc_defs + ("c_preprocessor_block_def",)),
        ...
        create_profile("orgmode", ("hash_space_orgmode_line_def",), handle_strings=False),
        create_profile("bat", ("rem_keyword_line_def", "batch_double_colon_line_def", "at_sign_batch_line_def"), handle_strings=False),
        ...
        create_profile("forth", ("forth_backslash_space_line_def", "forth_paren_spaced_block_def", "forth_paren_unspaced_block_def"), handle_strings=False),
        ...
        create_profile("ejs", ("ejs_percent_hash_block_def",), handle_strings=True),
        ...
        create_profile("unreal_shader_file", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("unreal_shader_header", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("unreal_project", ("c_line_comment_def", "c_block_comment_def"), handle_strings=True),
        create_profile("unreal_plugin_descriptor", ("c_line_comment_def", "c_block_comment_def"), handle_strings=True),
        create_profile("verse", ("hash_line_def", "powershell_hash_bracket_block_def")), # Using PowerShell block for Verse
        ...
        create_profile("glsl", c_style_base_defs + ("c_preprocessor_block_def",)),
        create_profile("hlsl", c_style_base_defs + ("c_preprocessor_block_def",)),
        create_profile("gradle", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("protobuf", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("textproto", ("hash_line_def",)),
        create_profile("kconfig", ("hash_line_def",), handle_strings=False),
        create_profile("rpm_spec", ("hash_line_def", "rpm_spec_changelog_block_def"), handle_strings=False),
        ...
        create_profile("wren", ("c_line_comment_def", "c_block_comment_def")),
        ...
        create_profile("jenkinsfile", ("c_line_comment_def", "c_block_comment_def")),
        ...
        create_profile("openscad", ("c_line_comment_def", "c_block_comment_def")),
        ...
        create_profile("povray_sdl", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("processing", c_style_doc_defs),
        create_profile("qml", ("c_line_comment_def", "c_block_comment_def")),
        ...
        create_profile("sourcepawn", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("sqf", ("c_line_comment_def", "c_block_comment_def")),
        ...
        create_profile("webidl", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("wdl", ("hash_line_def",)),
        create_profile("yang", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("csound", ("semicolon_line_def", "c_block_comment_def")),
        create_profile("supercollider", c_style_doc_defs),
        create_profile("chuck", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("faust", ("c_line_comment_def", "faust_triple_hyphen_doc_line_def", "c_block_comment_def")),
        create_profile("blitzmax", ("blitz_max_single_quote_line_def", "rem_blitz_max_lowercase_def", "rem_blitz_max_uppercase_def")),
        ...
        create_profile("smalltalk", ("smalltalk_double_quote_block_def", "exclamation_smalltalk_line_def")),
        ...
        create_profile("avro_idl", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("ballerina", ("c_line_comment_def",)),
        create_profile("bicep", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("bitbake", ("hash_line_def",)),
        create_profile("blitzbasic", ("rem_blitz_max_lowercase_def", "semicolon_line_def")),
        create_profile("brightscript", ("vb_single_quote_line_def", "rem_keyword_line_def")),
        create_profile("bsv", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("cadence", ("c_line_comment_def", "c_block_comment_def")),
        ...
        create_profile("chapel", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("cil", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("clarion", ("fortran_exclamation_line_def", "clarion_pipe_line_def")),
        create_profile("clean", ("c_line_comment_def", "c_block_comment_def")),
        ...
        create_profile("cue_lang", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("cython", ("python_hash_line_def", "python_triple_double_quote_block_def", "python_triple_single_quote_block_def")),
        create_profile("dafny", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("dylan", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("ecl", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("eiffel", ("double_hyphen_line_def",)),
        create_profile("factor", ("hash_line_def", "fortran_exclamation_line_def")),
        create_profile("fantom", ("c_line_comment_def", "c_block_comment_def")),
        ...
        create_profile("gosu", ("c_line_comment_def", "c_block_comment_def")),
        ...
        create_profile("jolie", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("jsoniq", ("xquery_block_def",)),
        create_profile("kusto_kql", ("c_line_comment_def",)),
        create_profile("lasso", ("c_line_comment_def", "c_block_comment_def")),
        ...
        create_profile("metal", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("modelica", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("modula3", ("pascal_paren_asterisk_block_def",)),
        create_profile("monkey_c", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("monkeyx", ("blitz_max_single_quote_line_def",)),
        create_profile("move_lang", ("c_line_comment_def", "c_block_comment_def")),
        ...
        create_profile("nextflow", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("nu", ("semicolon_line_def", "c_block_comment_def")),
        create_profile("nunjucks_tpl", ("twig_block_def",), handle_strings=True),
        create_profile("nwscript", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("objectivej", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("odin", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("openclc", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("openqasm", ("c_line_comment_def",)),
        create_profile("oz", ("percent_line_def",)),
        create_profile("p4_lang", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("papyrus_script", ("semicolon_line_def", "papyrus_brace_block_def")),
        create_profile("parasail", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("pawn", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("picat", ("percent_line_def",)),
        create_profile("pico_lisp", ("hash_line_def",)),
        create_profile("pike", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("plantuml", ("plantuml_single_quote_line_def", "plantuml_slash_apostrophe_block_def")),
        create_profile("pony", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("powerbuilder", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("powerfx", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("promela", ("c_line_comment_def", "c_block_comment_def")),
        ...
        create_profile("rpg", ("c_line_comment_def", "c_block_comment_def")), # Assuming free-form RPG
        ...
        create_profile("shen", ("backslash_forth_shen_line_def", "pascal_paren_asterisk_block_def")),
        ...
        create_profile("squirrel", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("starlark", ("hash_line_def",)),
        create_profile("swig", ("c_line_comment_def", "c_block_comment_def", "hash_line_def")),
        create_profile("systemverilog", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("tads", ("c_line_comment_def", "c_block_comment_def")),
        ...
        create_profile("v", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("verilog", ("c_line_comment_def", "c_block_comment_def")),
        ...
        create_profile("wgsl", ("c_line_comment_def", "c_block_comment_def")),
        create_profile("whiley", ("c_line_comment_def",)),
        create_profile("wikitext", ("html_xml_block_def",), handle_strings=False),
        create_profile("x10", ("c_line_comment_def", "c_block_comment_def")),
        ...
        create_profile("zephir", ("c_line_comment_def", "c_block_comment_def")),
